...
func GetRealTimePassengersTrip() (trips []models.ResponseTrip, err error) {
	query := "select * from (select * from passengers_trip order by create_time desc) as a group by phone limit 20"
