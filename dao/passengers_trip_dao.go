...
func GetRealTimePassengersTrip() (trips []models.ResponseTrip, err error) {
	query := "SELECT * from passengers_trip WHERE travel_time>= ? group by phone order by create_time desc  limit 20;"
